...
public class ModelTransactionBuilder {
  ...
  public ModelTransactionBuilder quorum(int quorum) {
    return new ModelTransactionBuilder(irohaJNI.ModelTransactionBuilder_quorum(swigCPtr, this, quorum), true);
  }

  public ModelTransactionBuilder batchMeta(BatchType type, HashVector hashes) {
    return new ModelTransactionBuilder(irohaJNI.ModelTransactionBuilder_batchMeta(swigCPtr, this, type.swigValue(), HashVector.getCPtr(hashes), hashes), true);
  }

  public ModelTransactionBuilder addAssetQuantity(String asset_id, String amount) {
    return new ModelTransactionBuilder(irohaJNI.ModelTransactionBuilder_addAssetQuantity(swigCPtr, this, asset_id, amount), true);
  }
  ...
  public ModelTransactionBuilder createRole(String role_name, RolePermissionSet permissions) {
    return new ModelTransactionBuilder(irohaJNI.ModelTransactionBuilder_createRole(swigCPtr, this, role_name, RolePermissionSet.getCPtr(permissions), permissions), true);
  }
  ...
  public ModelTransactionBuilder grantPermission(String account_id, Grantable permission) {
    return new ModelTransactionBuilder(irohaJNI.ModelTransactionBuilder_grantPermission(swigCPtr, this, account_id, permission.swigValue()), true);
  }

  public ModelTransactionBuilder revokePermission(String account_id, Grantable permission) {
    return new ModelTransactionBuilder(irohaJNI.ModelTransactionBuilder_revokePermission(swigCPtr, this, account_id, permission.swigValue()), true);
  }
  ...
  public ModelTransactionBuilder setAccountQuorum(String account_id, int quorum) {
  ...
  public ModelTransactionBuilder subtractAssetQuantity(String asset_id, String amount) {
    return new ModelTransactionBuilder(irohaJNI.ModelTransactionBuilder_subtractAssetQuantity(swigCPtr, this, asset_id, amount), true);
  }
